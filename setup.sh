...
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/dataset_1 bin/streamdm_*
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/dataset_2 bin/streamdm_*
make LABEL_COUNT=10 FEATURES_COUNT=6 -j 8 #dataset 3
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/dataset_3 bin/streamdm_*
make LABEL_COUNT=41 FEATURES_COUNT=6 BANOS=1 -j 8 #recofit
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/recofit_3 bin/streamdm_*
make LABEL_COUNT=41 FEATURES_COUNT=12 BANOS=1 -j 8 #recofit 6
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/recofit_6 bin/streamdm_*
...
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/banos_3 bin/streamdm_*
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/drift_3 bin/streamdm_*
make LABEL_COUNT=33 FEATURES_COUNT=12 BANOS=1 -j 8 #Banos 6 axis
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/banos_6 bin/streamdm_*
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/drift_6 bin/streamdm_*
...
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/banos_3_histogram bin/streamdm_*
make LABEL_COUNT=33 FEATURES_COUNT=120 BANOS=1 -j 8 #Banos 6 axis
cp bin/empty_classifier bin/mcnn_* bin/mondrian_* bin/mlp_* bin/naive_bayes bin/banos_6_histogram bin/streamdm_*

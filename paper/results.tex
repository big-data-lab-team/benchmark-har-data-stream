\begin{figure*}
	...
	\caption{F1 scores for the six datasets (average over 20 repetitions).
		The horizontal dashed black line indicate the offline \knn F1 score
		(the value of k was obtained by grid search in [2, 20]).}
	\label{fig:f1}
\end{figure*}
...
%FNN discussion
% On the other hand, the \FNN starts
...
%  phase, the \FNN would answer randomly. 
% We deviated from the method for the \FNN

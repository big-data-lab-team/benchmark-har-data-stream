...
runny()
{
	...
	#echo "
	#$binary $dataset.log $seed 3 $seed lifetime:0.5 base_measure:0.0 discount_factor:1.0 extend_type:original split_helper:none trim_type:$trim_type maximum_trim_size:$trim_size enable_tree_change:yes tree_count:$tree_count tree_count_target:$tree_count_target threshold_overfit:$threshold_overfit step_tree_change:$step_tree_change last_data_point:${dataset_last_data_point[$dataset]} stats_type:$stats_type
	#"
